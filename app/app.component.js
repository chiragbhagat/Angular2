System.register(['angular2/core', 'angular2/http', 'angular2/router', 'rxjs/Rx', './Components/Home/dashboard.component', './Components/Home/Inbox.component', './Components/Home/About.component', './Components/Home/Contact.component', './Components/Account/Register.component', './Components/Account/Profile.component', './Components/Account/ChangePassword.component', './Components/Account/ForgotPassword.component', './Components/ProductsList.component', './Components/Region.component', './Components/RegionAdd.component', './Components/Graph.component', './Components/Settings.component', './Components/Calendar.component', './Components/Account/Login.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, dashboard_component_1, Inbox_component_1, About_component_1, Contact_component_1, Register_component_1, Profile_component_1, ChangePassword_component_1, ForgotPassword_component_1, ProductsList_component_1, Region_component_1, RegionAdd_component_1, Graph_component_1, Settings_component_1, Calendar_component_1, Login_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (RegionAdd_component_1_1) {
                RegionAdd_component_1 = RegionAdd_component_1_1;
            },
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/Products', name: 'Products', component: ProductsList_component_1.ProductsListComponent },
                        { path: '/Region', name: 'Region', component: Region_component_1.RegionComponent },
                        { path: '/Region/Add', name: 'RegionAdd', component: RegionAdd_component_1.RegionAddComponent },
